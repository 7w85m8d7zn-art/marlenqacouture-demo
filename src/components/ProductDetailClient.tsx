...
export function ProductDetailClient({ product }: ProductDetailClientProps) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Merhaba, ${product.name} modeli hakkında bilgi almak istiyorum.\nKiralama/Özel dikim seçenekleri ve randevu için yardımcı olur musunuz?`
  )
  
  const whatsappLink = `https://wa.me/905317745680?text=${whatsappMessage}`
            ...
            >
              ...
              <div className="mb-6 pb-6 border-b">
                ...
                <p className="text-gray-600 text-sm mt-2">
                  {product.category === 'kiralama' ? 'Kiralama' : 'Özel dikim'} fiyatıdır
                </p>
              </div>

              {/* Color Selection */}
              <div className="mb-6">
                <label className="block text-sm font-semibold mb-3">Renk Seçimi</label>
              ...
              {/* Size Selection */}
              <div className="mb-6">
                <label className="block text-sm font-semibold mb-3">Beden Seçimi</label>
                <div className="flex flex-wrap gap-3">
              ...
              <div className="mt-8 pt-8 border-t">
                ...
                <ul className="space-y-3 text-gray-600 text-sm">
                  <li className="flex items-start gap-3">
                    <span>✓</span>
                    <span>{product.category === 'kiralama' ? 'Kiralama hizmetine konu olan' : 'Özel olarak tasarlanan'} premium kalite</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span>✓</span>
                    <span>Ölçü alımı ve danışmanlık hizmetleri sunulur</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span>✓</span>
                    <span>Ücretsiz alterasyon (değişiklik) yapılır</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span>✓</span>
                    <span>Deneme randevusu için showroom ziyareti önerilir</span>
                  </li>
                </ul>
              </div>
            </motion.div>
