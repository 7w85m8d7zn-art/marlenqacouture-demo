          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="mb-6 pb-6 border-b">
                <p className="text-gray-600 text-sm mb-2">Hizmet Başlangıç Fiyatı</p>
                ...
                <p className="text-gray-600 text-sm mt-2">
                  {product.category === 'bakim'
                    ...
                    : product.category === 'renklendirme'
                      ...
                      : product.category === 'kesim'
                        ? 'Kesim/Şekillendirme'
                        : 'Özel saç tasarımı'} hizmet başlangıç fiyatıdır
                </p>
              </div>

              {/* Color Selection */}
              <div className="mb-6">
                <label className="block text-sm font-semibold mb-3">Renk / Ton Seçimi</label>
              ...
              {/* Size Selection */}
              <div className="mb-6">
                <label className="block text-sm font-semibold mb-3">Seçenek / Paket</label>
                <div className="flex flex-wrap gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-auto pt-6">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="btn btn-primary flex-1 flex items-center justify-center gap-2 text-sm md:text-base py-3 md:py-4 px-4 md:px-6"
                >
              ...
              <div className="mt-8 pt-8 border-t">
                <h3 className="font-semibold mb-4">Hizmet Detayları</h3>
                <ul className="space-y-3 text-gray-600 text-sm">
                  <li className="flex items-start gap-3">
                    <span>✓</span>
                    <span>{product.category === 'tasarim' ? 'Kişiye özel tasarlanan' : 'Profesyonel standartlarda'} hizmet</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span>✓</span>
                    <span>Saç analizi ve stil danışmanlığı ile kişiye özel öneriler sunulur</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span>✓</span>
                    <span>Kaliteli ürünler ve hijyen odaklı uygulama standarttır</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span>✓</span>
                    <span>İşlem sonrası bakım önerileri ve ev rutini tavsiyeleri paylaşılır</span>
                  </li>
                </ul>
              </div>
            </motion.div>
