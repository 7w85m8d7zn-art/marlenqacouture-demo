              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  ...
                  <li className="text-sm text-gray-600 ml-6 mb-3">
                    Bu form aracılığıyla ya da WhatsApp'tan doğrudan talebinizi iletilebilirsiniz.
                  </li>

                  <li className="flex items-start gap-2">
                    <span className="text-rose font-bold">Q:</span>
                    <span>Kiralamada alterasyon yapılır mı?</span>
                  </li>
                  <li className="text-sm text-gray-600 ml-6">
                    Evet, tüm kiralama ürünlerinde ücretsiz alterasyon yapılır.
                  </li>
                </ul>
              </div>
            </motion.div>
