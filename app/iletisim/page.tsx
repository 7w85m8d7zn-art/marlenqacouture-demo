...
export default function ContactPage() {
  const whatsappMessage = encodeURIComponent(
    'Merhaba Dijital Showroom, saç hizmetleriniz hakkında bilgi almak istiyorum.'
  )
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto">
                Sorularınız mı var? Hizmetlerimiz hakkında bilgi almak veya randevu oluşturmak için bizimle iletişime geçin. En kısa sürede yanıt vereceğiz.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            >
                  ...
                  <div>
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@dijitalshowroom.com" className="text-rose hover:text-rose/80 transition-colors font-medium">
                          info@dijitalshowroom.com
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp üzerinden hızlı iletişim başlat"
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-lg font-serif font-bold mb-4">Hızlı Randevu Seç</h3>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { label: 'Saç Kesimi', msg: 'Saç kesimi için randevu almak istiyorum.' },
                    { label: 'Boya / Balayage', msg: 'Boya veya balayage işlemi için randevu almak istiyorum.' },
                    { label: 'Keratin Bakım', msg: 'Keratin saç bakımı için randevu almak istiyorum.' },
                    { label: 'Fön & Şekillendirme', msg: 'Fön ve şekillendirme için randevu almak istiyorum.' }
                  ].map((item) => {
                    const message = encodeURIComponent(`Merhaba, ${item.msg}`)
                    return (
                      <a
                        key={item.label}
                        href={`https://wa.me/905306249382?text=${message}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="border border-gray-200 rounded-md py-2 px-3 text-sm font-medium hover:bg-gray-50 transition-colors text-center"
                      >
                        {item.label}
                      </a>
                    )
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-rose font-bold">Q:</span>
                    <span>Boya / balayage işlemi ne kadar sürer?</span>
                  </li>
                  <li className="text-sm text-gray-600 ml-6">
                    Saçın uzunluğu ve uygulanacak tekniğe göre değişir. Ortalama 2-4 saat arası sürer. Net süre için fotoğraf paylaşarak ön değerlendirme alabilirsiniz.
                  </li>
                </ul>
              </div>
            </motion.div>
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative h-96 bg-gray-200 rounded-lg overflow-hidden">
              <iframe
                title="Dijital Showroom - Kırşehir / Merkez"
            ...
            <p className="text-center text-gray-600 mt-4">
              Harita tam konum göstermeyebilir. Kesin adres için lütfen WhatsApp'tan veya telefonla bizimle iletişime geçin.
            </p>
          </div>
        </motion.section>
      </main>
